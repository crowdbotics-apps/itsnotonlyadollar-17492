"""itsnotonlyadollar_17492 URL Configuration
...
admin.site.site_header = "ItsNotOnlyAdollar"
admin.site.site_title = "ItsNotOnlyAdollar Admin Portal"
admin.site.index_title = "ItsNotOnlyAdollar Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="ItsNotOnlyAdollar API",
        default_version="v1",
        description="API documentation for ItsNotOnlyAdollar App",
    ),
    public=True,
